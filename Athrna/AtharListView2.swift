...
struct AtharListView2: View {
    @ObservedObject var viewModel: AtharListViewModel2
    @State private var navigateToCandyMonsterB = false // تتبع الانتقال إلى CandyMonsterG
    ...
    var body: some View {
        NavigationStack {
            ...
            .background(
                NavigationLink(
                    destination: CandyMonsterG(selectedGirl: viewModel.selectedBoyImage), // استخدم CandyMonsterG بدلاً من CandyMonsterB
...
struct AtharListView2_Previews: PreviewProvider {
    static var previews: some View {
        AtharListView2(viewModel: AtharListViewModel2())
    }
}
